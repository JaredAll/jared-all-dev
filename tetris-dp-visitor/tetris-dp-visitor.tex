  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \umlclass[x=2, y=10, width=15ex]{ComponentVisitor}{
        ...
        \umlvirt{visitTetrisPiece(TetrisPiece\&) : void = 0} \\
        \umlvirt{visitTetrisBoard(TetrisBoard\&) : void = 0} \\
        \umlvirt{visitPanel(Panel\&) : void = 0}
      }
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \umlclass[x=2, y=0, width=15ex]{TetrisComponent}{
        ...
        \umlvirt{accept(ComponentVisitor\& visitor) : void = 0}
      }
      ...
      \umlclass[x=2, y=-7, width=15ex]{TetrisPiece}{
        ...
        \{ \\
        \hspace{0.3cm} visitor.visit( *this ); \\
        \}
      }
...
\begin{figure}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \umlclass[x=2, y=0, width=15ex]{Game}{
